...
const REGISTRY: Record<string, SourceSpec[]> = {
  telos: [
    ...
    { name: "PAI_STATE.json", path: join(TELOS_DIR, "PAI_STATE.json") },
  ...
  work: [
    { name: "STATE/work.json", path: join(PAI_DIR, "MEMORY", "STATE", "work.json") },
  ...
  knowledge: [
    { name: "KNOWLEDGE/", path: join(PAI_DIR, "MEMORY", "KNOWLEDGE"), expand: true },
  ],
  hooks: [
  ...
  docs: [
    { name: "DOCUMENTATION/", path: join(PAI_DIR, "DOCUMENTATION"), expand: true },
  ],
  arbol: [
  ...
  performance: [
    { name: "MEMORY/OBSERVABILITY/", path: join(PAI_DIR, "MEMORY", "OBSERVABILITY"), expand: true },
  ],
  assistant: [
