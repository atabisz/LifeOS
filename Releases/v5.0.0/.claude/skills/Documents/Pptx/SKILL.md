...
**Note**: The unpack.py script is located at `skills/Documents/Pptx/ooxml/Scripts/unpack.py` relative to the project root. If the script doesn't exist at this path, use `find . -name "unpack.py"` to locate it.
