...
> **This is THE doc for "what modes exist."** Pulse's tab strip is the user-facing surface. This directory holds one file per mode. `PAI/PULSE/Observability/src/app/agents/page.tsx` lines 23-30 is the runtime source of truth for tab labels and ordering.
...
- Pulse tab source of truth: `PAI/PULSE/Observability/src/app/agents/page.tsx` lines 23-30
- Dashboard components: `PAI/PULSE/Observability/src/components/activity/{UnifiedWorkDashboard,OptimizeDashboard,LoopDashboard,NativeDashboard,NoveltyDashboard}.tsx`
- Ladder page: `PAI/PULSE/Observability/src/app/ladder/page.tsx`
