...
- The output template is the NATIVE template (see `PAI/PAI_SYSTEM_PROMPT.md` § Mode Templates).
- No ISA is created.
...
- Tab: **Native**
- Dashboard: `NativeDashboard` (`PAI/PULSE/Observability/src/components/activity/NativeDashboard.tsx`)
...
- Mode templates (output shape): `PAI/PAI_SYSTEM_PROMPT.md` § "Mode Templates"
- Constitutional discriminator rule: `PAI/PAI_SYSTEM_PROMPT.md` § "Mode Architecture"
