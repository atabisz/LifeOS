...
1. Create directory: `mkdir ~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL/ACTIONS/A_YOUR_ACTION`
...
5. Deploy to cloud (optional): add Worker under `~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL/Workers/a-your-action/`, then `bash deploy.sh a-your-action`
...
```bash
cd ~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL
...
|----------|------|-------------|
| Source Code | `~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL/` | Cloudflare Workers source repository |
...
| Personal Actions | `~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL/ACTIONS/` | User-defined actions (override system) |
| Personal Pipelines | `~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL/PIPELINES/` | User-defined pipelines (override system) |
| Personal Flows | `~/.claude/PAI/USER/CUSTOMIZATIONS/ARBOL/FLOWS/` | User-defined flows (override system) |
