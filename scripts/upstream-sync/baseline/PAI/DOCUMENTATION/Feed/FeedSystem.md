...
- `PAI/USER/CUSTOMIZATIONS/ARBOL/` — Cloudflare Workers implementation (per-user customization area)
- `PAI/DOCUMENTATION/LifeosSystemArchitecture.md` — Master LifeOS architecture reference
