...
**Applies to:** `PAI/USER/` in every LifeOS installation
**Companion docs:** `PAI/DOCUMENTATION/LifeOs/LifeOsThesis.md` (the why), `PAI/DOCUMENTATION/Pulse/PulseSystem.md` (the dashboard), `skills/_LIFEOS/RELEASE_TEMPLATES/USER/` (the starter scaffold)
