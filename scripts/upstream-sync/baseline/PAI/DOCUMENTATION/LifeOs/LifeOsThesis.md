...
|--------------------|----------------|
| `PAI/DOCUMENTATION/LifeosSystemArchitecture.md` | Master architecture — subsystems, pipelines, instruction hierarchy |
...
| `~/Projects/PAI/README.md` | Public-facing pitch — open-source LifeOS framework |
