...
> Voice is the Life OS speaking. Notifications close the loop's feedback edge: when the system advances the hill-climb (`PAI/DOCUMENTATION/LifeOs/LifeOsThesis.md`), the principal hears it without having to look.
