...
find ~/Projects ~/LocalProjects ~/.claude -maxdepth 6 \
  ...
  -not -path "*/node_modules/*" -not -path "*/PAI_RELEASES/*" -not -path "*/.next/*" \
...
- Audit ISA that produced this runbook: `~/.claude/PAI/MEMORY/WORK/20260520-npm-exposure-audit/ISA.md`
- Implementation ISA: `~/.claude/PAI/MEMORY/WORK/20260520-npm-hardening-implementation/ISA.md`
