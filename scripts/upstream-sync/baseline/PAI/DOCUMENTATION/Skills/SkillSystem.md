...
- Can reference `~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/<SkillName>/` at runtime for per-user tweaks
...
`~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/{SkillName}/`
...
```
~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/
...
1. **Create directory**: `mkdir -p ~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/SkillName`
...
- **Master Architecture:** `~/.claude/PAI/DOCUMENTATION/LifeosSystemArchitecture.md` — authoritative system-of-systems reference
