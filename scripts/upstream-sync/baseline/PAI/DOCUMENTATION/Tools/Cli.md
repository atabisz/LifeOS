...
**Location:** `~/.claude/PAI/ARBOL/Actions/lifeos.ts`
...
1. **`PAI/USER/CUSTOMIZATIONS/ARBOL/ACTIONS/`** — Personal actions (override system actions)
2. **`PAI/ARBOL/Actions/`** — System/framework actions (includes examples)

Similarly, pipelines are searched in:

1. **`PAI/USER/CUSTOMIZATIONS/ARBOL/PIPELINES/`** — Personal pipelines
...
# The Arbol CLI
alias pai="bun ~/.claude/PAI/ARBOL/Actions/lifeos.ts"
...
|----------|------|-------------|
| System Architecture | `PAI/DOCUMENTATION/LifeosSystemArchitecture.md` | Master architecture reference |
