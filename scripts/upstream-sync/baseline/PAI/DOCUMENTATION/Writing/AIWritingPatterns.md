...
- **Voice guide:** `PAI/USER/PRINCIPAL/WRITINGSTYLE.md` — how {{PRINCIPAL_NAME}} sounds
- **Analytical voice:**  — how {{DA_NAME}} sounds in analysis
- **Rhetorical figures:** `PAI/USER/PRINCIPAL/WRITINGSTYLE.md` — techniques for memorable lines
