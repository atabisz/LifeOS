...
function detectExisting(
  ...
  // handoff. install.sh exports PAI_BUNDLE_DIR=$SCRIPT_DIR before launching
 ...
 * `PAI/USER/DIGITAL_ASSISTANT/DA_IDENTITY.md` and pulls the name from the
...
function detectDaName(paiDir: string, backupPaths: string[]): string | undefined {
  ...
  const relCandidates = [
    ...
    "PAI/USER/DIGITAL_ASSISTANT/IDENTITY.md",
