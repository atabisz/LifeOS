...
// component links: ~/.claude/PAI/ALGORITHM/modes/README.md
// Per-mode doctrine: ~/.claude/PAI/ALGORITHM/modes/{iterate,optimize,ideate,loop,native}.md
// Short summary lives in ~/.claude/PAI/DOCUMENTATION/Algorithm/AlgorithmSystem.md
