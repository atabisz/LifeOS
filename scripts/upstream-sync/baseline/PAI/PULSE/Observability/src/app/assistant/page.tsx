          ...
          <div className="space-y-6">
            <Section title="Scheduled Tasks · Claude Code" icon={Terminal} dimension="freedom">
              <div className="text-xs mono mb-1" style={{ color: "#9BB0D6" }}>
                Claude Code harness · <code className="mono">claude triggers list</code> (not under ~/.claude/PAI/)
              </div>
            ...
            >
              <div className="text-xs mono mb-1 space-y-0.5" style={{ color: "#9BB0D6" }}>
                <div>~/.claude/PAI/PULSE/PULSE.toml <span style={{ color: "#6B80AB" }}>(system · ships with LifeOS, never written by this UI)</span></div>
                <div>~/.claude/PAI/USER/CONFIG/PULSE.user.toml <span style={{ color: "#F87B7B" }}>(user · all edits/deletes from this UI write here)</span></div>
              </div>
              <div className="text-xs mb-3" style={{ color: "#6B80AB" }}>
