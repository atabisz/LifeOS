...
> **Source of truth:** `PAI/PULSE/Schema/PulseSchema.ts`
> **Companion:** `PAI/DOCUMENTATION/LifeOs/LifeOsSchema.md`
...
```bash
bun PAI/PULSE/Tools/ValidateSchema.ts <path-to-json>
```
...
3. Add a UI component under `PAI/PULSE/ui/components/`.
