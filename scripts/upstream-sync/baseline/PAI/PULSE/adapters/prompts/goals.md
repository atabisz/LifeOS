...
You receive the user's TELOS file (typically `PAI/USER/TELOS/TELOS.md`) — a long unified document with H2 sections including "Goals", "Active Goals", "Mission", "Strategies", "Problems", and others.
