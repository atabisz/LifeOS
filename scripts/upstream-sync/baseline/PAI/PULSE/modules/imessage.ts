...
async function processMessage(
  ...
  const sdkOptions: Record<string, unknown> = {
    ...
    // check PAI_NOTIFICATION_CHANNEL and skip their localhost:31337/notify
    ...
    env: { ...process.env, PAI_NOTIFICATION_CHANNEL: "imessage" },
    maxTurns,
...
A belt-and-suspenders egress sanitizer (PAI/PULSE/lib/strip-mode-scaffolding.ts) strips these markers if you emit them — but cleaner to never emit them.
