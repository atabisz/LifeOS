...
const CUSTOMIZATIONS_DIR = join(HOME, ".claude", "PAI", "USER", "CUSTOMIZATIONS", "SKILLS", "LocalIntelligence")
const LEGACY_DATA_DIR = join(HOME, ".claude", "PAI", "MEMORY", "DATA", "LocalIntelligence")
