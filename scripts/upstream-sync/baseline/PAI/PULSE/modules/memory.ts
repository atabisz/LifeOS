...
const PRINCIPAL_MEMORY = join(CLAUDE, "PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md");
const DA_MEMORY = join(CLAUDE, "PAI/USER/DIGITAL_ASSISTANT/DA_MEMORY.md");
const CADENCE_CONFIG = join(CLAUDE, "PAI/USER/CONFIG/memory-review.json");
