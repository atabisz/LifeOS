 ...
 *
 * Usage:
 *   bun ~/.claude/PAI/TOOLS/AlgoPhase.ts <phase> [--slug X] [--uuid X] [--iteration N]
 *
...
Examples:
  bun ~/.claude/PAI/TOOLS/AlgoPhase.ts think
  bun ~/.claude/PAI/TOOLS/AlgoPhase.ts build --slug 20260524-072107_pulse-agents
  bun ~/.claude/PAI/TOOLS/AlgoPhase.ts verify --uuid 49348c25-a71f-47f1-b038-0f26192f24bf
`);
}
