 ...
 *
 * Usage:
 *   bun PAI/TOOLS/CheckFileBoundary.ts <file>           # check file on disk
 *   bun PAI/TOOLS/CheckFileBoundary.ts <file> --stdin   # check content from stdin
 *   bun PAI/TOOLS/CheckFileBoundary.ts --help
 *
 * Exit codes:
