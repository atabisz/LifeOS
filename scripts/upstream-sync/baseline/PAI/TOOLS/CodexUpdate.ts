 ...
 *
 *   bun ~/.claude/PAI/TOOLS/CodexUpdate.ts            # update to @latest
 *   bun ~/.claude/PAI/TOOLS/CodexUpdate.ts --check    # report versions only
 *
...
const LOG = join(HOME, ".claude", "PAI", "MEMORY", "OBSERVABILITY", "codex-update.jsonl");
