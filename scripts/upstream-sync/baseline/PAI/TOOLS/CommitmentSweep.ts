 ...
 *
 *   bun ~/.claude/PAI/TOOLS/CommitmentSweep.ts             # apply
 *   bun ~/.claude/PAI/TOOLS/CommitmentSweep.ts --dry-run   # print digest, skip notify
 *   bun ~/.claude/PAI/TOOLS/CommitmentSweep.ts --notify    # force voice notify even when empty
 *
 * What it does:
