...
const PATH_PATTERNS = [
  // Backtick-quoted paths: `PAI/DOCUMENTATION/Hooks/HookSystem.md`, `hooks/PromptInjection.hook.ts`
...
function findDocs(): string[] {
  ...
  // LifeOS system docs (PAI_SYSTEM_PROMPT.md still lives at LifeOS root)
  try {
