 ...
 *
 * The statusline reads `~/.claude/PAI/USER/CACHE/freshness.json` directly
 ...
 *   4. CLI: `bun PAI/TOOLS/FreshnessCache.ts --rebuild`
 *
...
const CACHE_DIR = join(PAI_DIR, "USER", "CACHE");
