 ...
 * Both Banner.ts and PAI_StatusLine.sh MUST use this tool to ensure
...
// MEMORY/, USER/ live under PAI_DIR (which is CLAUDE_DIR/PAI).
const PAI_DIR = process.env.PAI_DIR || join(CLAUDE_DIR, "PAI");
