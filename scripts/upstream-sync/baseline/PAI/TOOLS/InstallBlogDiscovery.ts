 ...
 *
 *   bun ~/.claude/PAI/TOOLS/InstallBlogDiscovery.ts             # install
 *   bun ~/.claude/PAI/TOOLS/InstallBlogDiscovery.ts --uninstall # remove
 *   bun ~/.claude/PAI/TOOLS/InstallBlogDiscovery.ts --status    # check
 *
