 ...
 *
 *   bun ~/.claude/PAI/TOOLS/InstallBookmarkSweep.ts             # install
 *   bun ~/.claude/PAI/TOOLS/InstallBookmarkSweep.ts --uninstall # remove
 *   bun ~/.claude/PAI/TOOLS/InstallBookmarkSweep.ts --status    # check
 *
