 ...
 *
 *   bun ~/.claude/PAI/TOOLS/InstallCodexUpdate.ts             # install
 *   bun ~/.claude/PAI/TOOLS/InstallCodexUpdate.ts --uninstall # remove
 *   bun ~/.claude/PAI/TOOLS/InstallCodexUpdate.ts --status    # check
 *
