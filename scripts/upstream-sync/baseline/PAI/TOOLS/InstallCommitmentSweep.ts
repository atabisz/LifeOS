 ...
 *
 *   bun ~/.claude/PAI/TOOLS/InstallCommitmentSweep.ts             # install
 *   bun ~/.claude/PAI/TOOLS/InstallCommitmentSweep.ts --uninstall # remove
 *
...
const STATE_DIR = join(HOME, ".claude", "PAI", "MEMORY", "STATE");
