 ...
 *
 *   bun ~/.claude/PAI/TOOLS/InstallHealthSync.ts             # install
 *   bun ~/.claude/PAI/TOOLS/InstallHealthSync.ts --uninstall # remove
 *   bun ~/.claude/PAI/TOOLS/InstallHealthSync.ts --status    # check
 */
