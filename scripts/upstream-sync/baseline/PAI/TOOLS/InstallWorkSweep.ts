 ...
 *
 *   bun ~/.claude/PAI/TOOLS/InstallWorkSweep.ts             # install
 *   bun ~/.claude/PAI/TOOLS/InstallWorkSweep.ts --uninstall # remove
 *   bun ~/.claude/PAI/TOOLS/InstallWorkSweep.ts --status    # check
 *
