...
//
// Usage:
//   bun run ~/.claude/PAI/TOOLS/IsaReconcile.ts                       (default: --audit)
//   bun run ~/.claude/PAI/TOOLS/IsaReconcile.ts --audit               (report drift, no writes)
//   bun run ~/.claude/PAI/TOOLS/IsaReconcile.ts --fix                 (sync drift into work.json)
//   bun run ~/.claude/PAI/TOOLS/IsaReconcile.ts --fix --abandon-old-verify
//     also marks stranded phase:verify ISAs >7d old as phase:complete (writes ISA frontmatter)
//   bun run ~/.claude/PAI/TOOLS/IsaReconcile.ts --json                (machine-readable)
//
