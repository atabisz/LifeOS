...
const MEMORY_FILES: ReadonlyArray<{ path: string; title: string }> = [
  { path: path.join(HOME, ".claude", "PAI", "USER", "PRINCIPAL", "PRINCIPAL_MEMORY.md"), title: "Principal Memory" },
  { path: path.join(HOME, ".claude", "PAI", "USER", "DIGITAL_ASSISTANT", "DA_MEMORY.md"), title: "DA Memory" },
];
