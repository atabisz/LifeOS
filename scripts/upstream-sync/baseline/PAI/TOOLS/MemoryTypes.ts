...
const PAI_DIR = pathJoin(CLAUDE_ROOT, "PAI");
const KNOWLEDGE_DIR = pathJoin(PAI_DIR, "MEMORY", "KNOWLEDGE");

export const PRINCIPAL_MEMORY_PATH = pathJoin(PAI_DIR, "USER", "PRINCIPAL", "PRINCIPAL_MEMORY.md");
export const DA_MEMORY_PATH = pathJoin(PAI_DIR, "USER", "DIGITAL_ASSISTANT", "DA_MEMORY.md");
export const PENDING_PROPOSALS_PATH = pathJoin(PAI_DIR, "MEMORY", "OBSERVABILITY", "pending-proposals.jsonl");
export const TIER_B_AUDIT_PATH = pathJoin(PAI_DIR, "MEMORY", "OBSERVABILITY", "tier-b-writes.jsonl");
...
export const PRINCIPAL_IDENTITY_PATH = pathJoin(PAI_DIR, "USER", "PRINCIPAL", "PRINCIPAL_IDENTITY.md");
export const DA_IDENTITY_PATH = pathJoin(PAI_DIR, "USER", "DIGITAL_ASSISTANT", "DA_IDENTITY.md");
export const WRITINGSTYLE_PATH = pathJoin(PAI_DIR, "USER", "PRINCIPAL", "WRITINGSTYLE.md");
export const RESUME_PATH = pathJoin(PAI_DIR, "USER", "PRINCIPAL", "RESUME.md");
export const DEFINITIONS_PATH = pathJoin(PAI_DIR, "USER", "DEFINITIONS.md");
export const CANONICAL_CONTENT_PATH = pathJoin(PAI_DIR, "USER", "CANONICAL_CONTENT.md");
export const OPERATIONAL_RULES_PATH = pathJoin(PAI_DIR, "USER", "CONFIG", "OPERATIONAL_RULES.md");
export const PROJECTS_PATH = pathJoin(PAI_DIR, "USER", "PROJECTS.md");
export const CONTACTS_PATH = pathJoin(PAI_DIR, "USER", "CONTACTS.md");
 ...
 * already in use across PAI/MEMORY/KNOWLEDGE/ — the 8 supported relationship
