 ...
 *   PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md
 *   PAI/USER/DIGITAL_ASSISTANT/DA_MEMORY.md
 *
...
const OBSERVABILITY_PATH = pathResolve(
  CLAUDE_ROOT,
  "PAI/MEMORY/OBSERVABILITY/memory-writes.jsonl",
);
...
const SNAPSHOT_DIR = pathResolve(CLAUDE_ROOT, "<REDACTED:high-entropy>");
...
function smokeTest(): number {
  ...
  const testFile = pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md");
