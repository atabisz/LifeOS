 ...
 *
 * Usage:
 *   bun ~/.claude/PAI/TOOLS/MigrateTelosFreshness.ts            # apply
 *   bun ~/.claude/PAI/TOOLS/MigrateTelosFreshness.ts --dry-run  # show diff
 */
...
const BACKUP_DIR = join(PAI_DIR, "USER", "TELOS", "Backups");
