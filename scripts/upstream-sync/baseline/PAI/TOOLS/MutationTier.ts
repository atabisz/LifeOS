...
const TIER_A_FILES: ReadonlySet<string> = new Set([
  pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/DIGITAL_ASSISTANT/DA_MEMORY.md"),
]);

/** Tier B: append-with-audit files (exact-match paths). */
const TIER_B_FILES: ReadonlySet<string> = new Set([
  pathResolve(CLAUDE_ROOT, "PAI/USER/PROJECTS.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/CONTACTS.md"),
]);

/** Tier B: append-with-audit prefixes (any file beneath these dirs is Tier B). */
const TIER_B_PREFIXES: readonly string[] = [
  pathResolve(CLAUDE_ROOT, "PAI/MEMORY/KNOWLEDGE") + "/",
  pathResolve(CLAUDE_ROOT, "PAI/MEMORY/IDEAS") + "/",
];

/** Tier C: propose-only identity-doctrine files (exact-match paths). */
const TIER_C_FILES: ReadonlySet<string> = new Set([
  pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/PRINCIPAL_IDENTITY.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/DIGITAL_ASSISTANT/DA_IDENTITY.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/WRITINGSTYLE.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/DEFINITIONS.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/CANONICAL_CONTENT.md"),
  pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/RESUME.md"),
]);
...
function smokeTest(): number {
  ...
  const cases: Case[] = [
    ...
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md"),
      expected: "A",
      why: "PRINCIPAL_MEMORY.md is hot-layer autonomic",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/DIGITAL_ASSISTANT/DA_MEMORY.md"),
      expected: "A",
    ...
    // Tier B — exact-match
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/PROJECTS.md"),
      expected: "B",
      why: "PROJECTS.md is append-with-audit",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/CONTACTS.md"),
      expected: "B",
    ...
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/MEMORY/KNOWLEDGE/People/{{PRINCIPAL_NAME}}.md"),
      expected: "B",
      why: "KNOWLEDGE/People/* is append-with-audit",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/MEMORY/KNOWLEDGE/Ideas/some-idea.md"),
      expected: "B",
    ...
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/PRINCIPAL_IDENTITY.md"),
      expected: "C",
      why: "PRINCIPAL_IDENTITY.md is propose-only",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/DIGITAL_ASSISTANT/DA_IDENTITY.md"),
      expected: "C",
      why: "DA_IDENTITY.md is propose-only",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/WRITINGSTYLE.md"),
      expected: "C",
      why: "WRITINGSTYLE.md is propose-only",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/DEFINITIONS.md"),
      expected: "C",
      why: "DEFINITIONS.md is propose-only",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/CANONICAL_CONTENT.md"),
      expected: "C",
      why: "CANONICAL_CONTENT.md is propose-only",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/RESUME.md"),
      expected: "C",
    ...
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/PAI_SYSTEM_PROMPT.md"),
      expected: "D",
      why: "PAI_SYSTEM_PROMPT.md is constitutional, untouchable",
    },
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/ALGORITHM/v6.9.0.md"),
      expected: "D",
    ...
    {
      path: pathResolve(CLAUDE_ROOT, "PAI/USER/some_brand_new_file_2026.md"),
      expected: "D",
      why: "ISC-105 anti: unknown file defaults to Tier D",
    },
    // Relative path defensive case
    {
      path: "PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md",
      expected: "D",
