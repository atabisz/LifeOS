...
const PAI_DIR = join(CLAUDE_DIR, 'LIFEOS');
...
const EXCLUDE_PATH_PREFIXES = [
  'PAI/MEMORY',
  'PAI/USER/MEMORY',        // post-Phase-G symlink target — MEMORY moved into the user's private USER-data repo (2026-05-22→23)
  'PAI/PULSE/Observability/.next',
  '<REDACTED:high-entropy>',
  'PAI/PULSE/state',        // runtime state — not docs
  'PAI/PAI_RELEASES',
  'PAI_RELEASES',
  '<REDACTED:high-entropy>',       // user's own actions with example paths
  'PAI/USER/CUSTOMIZATIONS/ARBOL',         // private worker tree
  'PAI/USER/DAEMON',        // private daemon work
  'PAI/USER/CUSTOMIZATIONS/SKILLS',
...
function isArchivedAlgorithmVersion(relPath: string): boolean {
  if (relPath === 'PAI/ALGORITHM/changelog.md') return true;
...
function getLatestAlgorithmVersion(): string {
  ...
  // Source of truth: PAI/ALGORITHM/LATEST file (a single-line version string).
