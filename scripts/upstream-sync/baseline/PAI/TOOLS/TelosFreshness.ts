 ...
 *   - PAI/PULSE/modules/telos.ts → /api/telos/freshness, DA-panel surface
 *
 * Convention:
 ...
 *
 * CLI:
 *   bun ~/.claude/PAI/TOOLS/TelosFreshness.ts                 → human report
 *   bun ~/.claude/PAI/TOOLS/TelosFreshness.ts --json          → machine-readable
 *   bun ~/.claude/PAI/TOOLS/TelosFreshness.ts --bump <slug>   → mark a section fresh
 */
...
const TELOS_PATH = join(PAI_DIR, "USER", "TELOS", "TELOS.md");
const DA_IDENTITY_PATH = join(PAI_DIR, "USER", "DIGITAL_ASSISTANT", "DA_IDENTITY.md");
const PRINCIPAL_IDENTITY_PATH = join(PAI_DIR, "USER", "PRINCIPAL", "PRINCIPAL_IDENTITY.md");
const PROJECTS_PATH = join(PAI_DIR, "USER", "PROJECTS.md");
const PAI_SYSTEM_PROMPT_PATH = join(PAI_DIR, "PAI_SYSTEM_PROMPT.md");
const PRINCIPAL_TELOS_PATH = join(PAI_DIR, "USER", "TELOS", "PRINCIPAL_TELOS.md");
const ARCHITECTURE_SUMMARY_PATH = join(PAI_DIR, "DOCUMENTATION", "ARCHITECTURE_SUMMARY.md");
const PAI_ARCHITECTURE_PATH = join(PAI_DIR, "DOCUMENTATION", "LifeosSystemArchitecture.md");
const PAI_SYSTEM_ARCHITECTURE_PATH = PAI_ARCHITECTURE_PATH; // alias for clarity
...
export const CONTEXT_FRESHNESS_REGISTRY: ContextFile[] = [
  ...
  { slug: "pai_system_prompt", path: PAI_SYSTEM_PROMPT_PATH, threshold_days: 90, is_auto_generated: false },
  { slug: "principal_telos", path: PRINCIPAL_TELOS_PATH, threshold_days: 30, derived_from: TELOS_PATH, is_auto_generated: true },
  { slug: "architecture_summary", path: ARCHITECTURE_SUMMARY_PATH, threshold_days: 30, derived_from: PAI_ARCHITECTURE_PATH, is_auto_generated: true },
  { slug: "pai_system_architecture", path: PAI_SYSTEM_ARCHITECTURE_PATH, threshold_days: 90, is_auto_generated: false },
];
