...
2. **Add to PATH (optional):**
   ...
   export PATH="$HOME/.claude/PAI/TOOLS/llcli:$PATH"
   ```
...
```bash
chmod +x ~/.claude/PAI/TOOLS/llcli/llcli.ts
```
...
**New:**
```bash
~/.claude/PAI/TOOLS/llcli/llcli.ts today --limit 20
```
