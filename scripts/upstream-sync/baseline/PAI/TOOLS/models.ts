 ...
 *                       PAI_StatusLine.sh § "Effort↔tier nudge" (2026-06-29).
 *
 ...
 *                       (PAI_StatusLine.sh promotes XHIGH→ULT). It belongs to
 ...
 * ============================================================================
 * Machine-readable form of PAI/DOCUMENTATION/Security/DataClassification.md.
