...
> Principal-bound operational rules, imported into context every session. The system prompt (`PAI/PAI_SYSTEM_PROMPT.md`) carries the domain-agnostic rules everyone runs; this file is where YOUR specifics live — your tooling choices, your environment, your vendor-specific gotchas, conventions for your own repos.
