 ...
 * routing matrix (PAI/DOCUMENTATION/Security/DataClassification.md).
 *
 ...
 * PAI/USER/** (CONFIDENTIAL) reference handed to the GLM/OpenRouter route
...
const LOG_PATH = join(HOME, ".claude/PAI/MEMORY/OBSERVABILITY/egress-decisions.jsonl");
