...
const PRINCIPAL_MEMORY = pathResolve(CLAUDE_ROOT, "PAI/USER/PRINCIPAL/PRINCIPAL_MEMORY.md");
const DA_MEMORY = pathResolve(CLAUDE_ROOT, "PAI/USER/DIGITAL_ASSISTANT/DA_MEMORY.md");
