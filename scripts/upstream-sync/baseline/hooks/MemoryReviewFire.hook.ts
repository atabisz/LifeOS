...
const FIRE_LOG_PATH = pathResolve(CLAUDE_ROOT, "PAI/MEMORY/OBSERVABILITY/reviewer-fires.jsonl");
const REVIEWER_PATH = pathResolve(CLAUDE_ROOT, "PAI/TOOLS/MemoryReviewer.ts");
