 ...
 * sees renders on the deterministic `🧠 MEM` statusline line (PAI_StatusLine.sh),
 ...
 *
 * Cadence parameters: PAI/USER/CONFIG/memory-review.json (hardcoded fallbacks).
 *
...
const STATE_PATH = pathResolve(CLAUDE_ROOT, "PAI/MEMORY/OBSERVABILITY/review-state.json");
const CONFIG_PATH = pathResolve(CLAUDE_ROOT, "PAI/USER/CONFIG/memory-review.json");
const EFFORT_ROUTER_LOG = pathResolve(CLAUDE_ROOT, "PAI/MEMORY/OBSERVABILITY/effort-router.jsonl");
