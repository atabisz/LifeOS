 ...
 * by diffing it against the actual directory tree under PAI/MEMORY/. Surfaces
 ...
 *
 * READS:
 *   PAI/DOCUMENTATION/Memory/MemorySystem.md (Directory Inventory table)
 *   PAI/MEMORY/                                (one level deep)
 *
 * WRITES:
