 ...
 * from PAI/TOOLS/models.ts (maxClassForRoute); the payload class comes from a
 ...
 * in PAI/DOCUMENTATION/Security/DataClassification.md).
 */
...
/** Sensitive path references — mirrors PAI/USER/CONFIG/data-classification.json.
 * Most-sensitive match wins (RESTRICTED sub-paths beat the PAI/USER CONFIDENTIAL default). */
