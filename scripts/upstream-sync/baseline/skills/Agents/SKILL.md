...
```
~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/Agents/
...
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --task "Review security"
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --task "Security review" --save
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --list-saved
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --load "<REDACTED:high-entropy>"
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --delete "<REDACTED:high-entropy>"

# Other options
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --list
bun run ${PAI_SKILL_DIR}/Tools/ComposeAgent.ts --output json
```
