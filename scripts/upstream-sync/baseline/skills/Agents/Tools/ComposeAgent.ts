 ...
 *   User:  ~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/Agents/Traits.yaml
 *
 * Usage:
...
const USER_TRAITS_PATH = `${HOME}/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/Agents/Traits.yaml`;
...
CONFIGURATION:
  ...
  User traits:    ~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/Agents/Traits.yaml
