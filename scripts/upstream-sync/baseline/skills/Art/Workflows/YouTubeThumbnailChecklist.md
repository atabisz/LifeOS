...
□ Selected specific headshot file from `PAI/USER/CUSTOMIZATIONS/SKILLS/Art/HeadshotExamples/` (your private headshots) OR
...
□ Headshot is appropriate existing photo from `PAI/USER/CUSTOMIZATIONS/SKILLS/Art/HeadshotExamples/`
