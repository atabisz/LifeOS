...
For more information, see ~/.claude/PAI/TOOLS/{{CLI_NAME}}/README.md
...
See: ~/.claude/PAI/TOOLS/{{CLI_NAME}}/README.md
```
...
**Report to user:**
```
✅ CLI Created: ~/.claude/PAI/TOOLS/{{CLI_NAME}}/
...
Documentation: ~/.claude/PAI/TOOLS/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: ~/.claude/PAI/TOOLS/notioncli/
...
3. Read: ~/.claude/PAI/TOOLS/notioncli/README.md
...
Use proven structure from ~/.claude/PAI/TOOLS/llcli/ as reference.
