...
```
~/.claude/PAI/MEMORY/STATE/Evals-Results/<use-case>/<run-id>/results.json
```
...
ls -1t ~/.claude/PAI/MEMORY/STATE/Evals-Results/<use-case>/
...
LATEST=$(ls -1t ~/.claude/PAI/MEMORY/STATE/Evals-Results/<use-case>/ | head -1)
cat ~/.claude/PAI/MEMORY/STATE/Evals-Results/<use-case>/$LATEST/results.json | jq '.summary'

# Or for a specific run
cat ~/.claude/PAI/MEMORY/STATE/Evals-Results/<use-case>/<run-id>/results.json | jq '.summary'
```
