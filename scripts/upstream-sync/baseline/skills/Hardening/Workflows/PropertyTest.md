...
- Testing Doctrine Rule #11 — fast-check as approved primitive (`PAI/DOCUMENTATION/Testing/TestingDoctrine.md`)
- IsaFormat.md ISC Type Vocabulary — `bun-property` schema (`PAI/DOCUMENTATION/ISA/IsaFormat.md`)
- Algorithm v6.10.0 candidate — VERIFY hardening gate, PropertyAudit capability (`PAI/ALGORITHM/v6.10.0.md`)
