...
| Optional regional outlets | via `PAI/USER/CUSTOMIZATIONS/SKILLS/LocalIntelligence/PREFERENCES.md` |

## Optional Customization Layer

Per-user source overrides go in `~/.claude/PAI/USER/CUSTOMIZATIONS/SKILLS/LocalIntelligence/PREFERENCES.md`. Examples: an OpenStates API key for higher rate limits, a Google News topic ID, additional regional newspaper RSS feeds. The skill body never hardcodes any of this.
