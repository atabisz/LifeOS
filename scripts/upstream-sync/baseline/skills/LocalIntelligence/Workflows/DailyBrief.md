...
3. Read the resulting `~/.claude/PAI/MEMORY/DATA/LocalIntelligence/latest.json`.
...
- File: `~/.claude/PAI/MEMORY/DATA/LocalIntelligence/<YYYY-MM-DD>_<city>_<state>_digest.json`
- Symlink: `~/.claude/PAI/MEMORY/DATA/LocalIntelligence/latest.json`
