...
- The saved interview for this book: `PAI/USER/CUSTOMIZATIONS/SKILLS/WriteStory/projects/<book-slug>/interview.md` — read it first. It carries the confirmed spine, the derivation lens used, the per-layer state, and the one-page **Foolscap spine** (theme, dramatic question, hook, climax, three acts). BuildBible expands that spine; it does not start over.
...
**Location:** `PAI/USER/CUSTOMIZATIONS/SKILLS/WriteStory/projects/<book-slug>/ISA.md`
